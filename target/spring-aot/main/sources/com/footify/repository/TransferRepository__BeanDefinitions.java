...
/**
 * Bean definitions for {@link TransferRepository}.
 */
@Generated
public class TransferRepository__BeanDefinitions {
  /**
   * Get the bean instance supplier for 'transferRepository'.
   */
  private static BeanInstanceSupplier<JpaRepositoryFactoryBean> getTransferRepositoryInstanceSupplier(
      ) {
  ...
  /**
   * Get the bean definition for 'transferRepository'.
   */
  public static BeanDefinition getTransferRepositoryBeanDefinition() {
    RootBeanDefinition beanDefinition = new RootBeanDefinition(JpaRepositoryFactoryBean.class);
    beanDefinition.setTargetType(ResolvableType.forClassWithGenerics(JpaRepositoryFactoryBean.class, TransferRepository.class, Transfer.class, Long.class));
    beanDefinition.setLazyInit(false);
    beanDefinition.getConstructorArgumentValues().addIndexedArgumentValue(0, "com.footify.repository.TransferRepository");
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragments", new RuntimeBeanReference("jpa.TransferRepository.fragments#0"));
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragmentsFunction", new RepositoryFactoryBeanSupport.RepositoryFragmentsFunction() {
      public RepositoryComposition.RepositoryFragments getRepositoryFragments(
        ...
        return RepositoryComposition.RepositoryFragments.just(new com.footify.repository.TransferRepositoryImpl__AotRepository(entityManager, context));
      }
    });
    InstanceSupplier<JpaRepositoryFactoryBean> instanceSupplier = getTransferRepositoryInstanceSupplier();
