...
/**
 * Bean definitions for {@link TrophyRepository}.
 */
@Generated
public class TrophyRepository__BeanDefinitions {
  /**
   * Get the bean instance supplier for 'trophyRepository'.
   */
  private static BeanInstanceSupplier<JpaRepositoryFactoryBean> getTrophyRepositoryInstanceSupplier(
      ) {
  ...
  /**
   * Get the bean definition for 'trophyRepository'.
   */
  public static BeanDefinition getTrophyRepositoryBeanDefinition() {
    RootBeanDefinition beanDefinition = new RootBeanDefinition(JpaRepositoryFactoryBean.class);
    beanDefinition.setTargetType(ResolvableType.forClassWithGenerics(JpaRepositoryFactoryBean.class, TrophyRepository.class, Trophy.class, Long.class));
    beanDefinition.setLazyInit(false);
    beanDefinition.getConstructorArgumentValues().addIndexedArgumentValue(0, "com.footify.repository.TrophyRepository");
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragments", new RuntimeBeanReference("jpa.TrophyRepository.fragments#0"));
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragmentsFunction", new RepositoryFactoryBeanSupport.RepositoryFragmentsFunction() {
      public RepositoryComposition.RepositoryFragments getRepositoryFragments(
        ...
        return RepositoryComposition.RepositoryFragments.just(new com.footify.repository.TrophyRepositoryImpl__AotRepository(entityManager, context));
      }
    });
    InstanceSupplier<JpaRepositoryFactoryBean> instanceSupplier = getTrophyRepositoryInstanceSupplier();
