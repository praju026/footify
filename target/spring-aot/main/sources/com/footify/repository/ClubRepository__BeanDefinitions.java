...
/**
 * Bean definitions for {@link ClubRepository}.
 */
@Generated
public class ClubRepository__BeanDefinitions {
  /**
   * Get the bean instance supplier for 'clubRepository'.
   */
  private static BeanInstanceSupplier<JpaRepositoryFactoryBean> getClubRepositoryInstanceSupplier(
      ) {
  ...
  /**
   * Get the bean definition for 'clubRepository'.
   */
  public static BeanDefinition getClubRepositoryBeanDefinition() {
    RootBeanDefinition beanDefinition = new RootBeanDefinition(JpaRepositoryFactoryBean.class);
    beanDefinition.setTargetType(ResolvableType.forClassWithGenerics(JpaRepositoryFactoryBean.class, ClubRepository.class, Club.class, Long.class));
    beanDefinition.setLazyInit(false);
    beanDefinition.getConstructorArgumentValues().addIndexedArgumentValue(0, "com.footify.repository.ClubRepository");
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragments", new RuntimeBeanReference("jpa.ClubRepository.fragments#0"));
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragmentsFunction", new RepositoryFactoryBeanSupport.RepositoryFragmentsFunction() {
      public RepositoryComposition.RepositoryFragments getRepositoryFragments(
        ...
        return RepositoryComposition.RepositoryFragments.just(new com.footify.repository.ClubRepositoryImpl__AotRepository(entityManager, context));
      }
    });
    InstanceSupplier<JpaRepositoryFactoryBean> instanceSupplier = getClubRepositoryInstanceSupplier();
