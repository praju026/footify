 ...
 */
@Generated
public class FootifyApplication__ApplicationContextInitializer implements ApplicationContextInitializer<GenericApplicationContext> {
  @Override
  public void initialize(GenericApplicationContext applicationContext) {
    ...
    new FootifyApplication__BeanFactoryRegistrations().registerBeanDefinitions(beanFactory);
    new FootifyApplication__BeanFactoryRegistrations().registerAliases(beanFactory);
  }
